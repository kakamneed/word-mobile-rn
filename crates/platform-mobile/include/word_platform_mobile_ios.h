...
char *word_mobile_ios_get_reward_image_upload_entitlement(void);
char *word_mobile_ios_refresh_reward_image_upload_entitlement(const char *request_json);
char *word_mobile_ios_create_reward_image_upload(const char *request_json);
char *word_mobile_ios_list_reward_images(const char *request_json);
char *word_mobile_ios_moderate_reward_image(const char *request_json);
char *word_mobile_ios_select_leaderboard_reward_image_tag(const char *request_json);
char *word_mobile_ios_vote_reward_image(const char *request_json);
char *word_mobile_ios_get_local_leaderboard(const char *request_json);
char *word_mobile_ios_refresh_local_leaderboard_summary(const char *request_json);
char *word_mobile_ios_seed_local_leaderboard_demo(void);
...
char *word_mobile_ios_get_exam_catalog(void);
char *word_mobile_ios_get_exam_paper(const char *request_json);
char *word_mobile_ios_analyze_exam_paper_import(const char *request_json);
char *word_mobile_ios_save_user_exam_paper(const char *request_json);
char *word_mobile_ios_get_exam_vocabulary_priority(void);
char *word_mobile_ios_get_exam_practice_report(void);
char *word_mobile_ios_analyze_exam_question_vocabulary(const char *request_json);
char *word_mobile_ios_analyze_exam_section_vocabulary(const char *request_json);
char *word_mobile_ios_save_exam_analysis_task(const char *request_json);
char *word_mobile_ios_get_exam_analysis_tasks(void);
char *word_mobile_ios_mark_exam_analysis_tasks_read(void);
char *word_mobile_ios_save_exam_attempt(const char *request_json);
char *word_mobile_ios_get_exam_attempt(const char *request_json);
char *word_mobile_ios_tokenize_exam_text(const char *request_json);
char *word_mobile_ios_inspect_exam_word(const char *request_json);
char *word_mobile_ios_get_exam_annotation_state(const char *request_json);
char *word_mobile_ios_save_exam_annotation(const char *request_json);
...
char *word_mobile_ios_mark_study_entry_mastered(const char *request_json);

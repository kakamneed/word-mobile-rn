...
const _profileVisuals =
    <String, ({String title, String assetPath, String flavor})>{
      'VINA': (
        title: '鳄卷师',
...
Map<String, dynamic> crocBtiPlanInputFor(
  ...
  bool? growthRuleEnabled,
}) {
  return <String, dynamic>{
    'name': result.title,
    ...(planInput ?? result.planInput),
    'growthRuleEnabled': growthRuleEnabled ?? plan.growthRuleEnabled,

...
$apk = Join-Path $PSScriptRoot 'word-mobile-1.0.2+3.apk'
$notes = Join-Path $PSScriptRoot 'v1.0.2-release-notes.md'
$tag = 'v1.0.2'
$title = 'Word Mobile 1.0.2'
...
& $gh.Source release create $tag "$apk#word-mobile-1.0.2+3.apk" `
